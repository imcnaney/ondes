...
The engine has also been ported to C ([CPort.md](c/doc/CPort.md)), which holds render parity with the Java reference; per-note and per-sample timings are in [c/doc/timings.md](c/doc/timings.md).
